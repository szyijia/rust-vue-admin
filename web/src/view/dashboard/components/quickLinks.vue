  ...
  <div class="h-full space-y-5">
    <div>
      ...
      <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
        <button v-for="(item, index) in shortcuts" :key="index"
    ...
    <div>
      ...
      <div class="space-y-2">
        <button v-for="(item, index) in recentVisits" :key="index"
          ...
          type="button" @click="openLink(item)">
...
const shortcuts = [
  { icon: User, title: '个人信息', path: 'person' },
...
const recentVisits = [
  { icon: Document, title: '项目文档', path: 'https://github.com/szyijia/rust-vue-admin' },
]
</script>
