<template>
  <div
    class="rounded-lg flex items-center justify-evenly w-full h-full relative md:w-screen md:h-screen  overflow-hidden">
    <div class="rounded-md w-full h-full flex items-center justify-center overflow-hidden">
      ...
      <div v-if="!page.showForm" :class="[page.showReadme ? 'slide-out-right' : 'slide-in-fwd-top']">
        <div class="text-lg">
          ...
          <p class="text-gray-600 dark:text-gray-300 mb-2">
            3. 初始化完成后将自动创建 admin 账号
          </p>
          <p class="text-gray-600 dark:text-gray-300 mb-2">
            4. 如果您使用 MySQL，请确认数据库引擎为<span class="text-red-600 font-bold text-3xl ml-2">innoDB</span>
          </p>
